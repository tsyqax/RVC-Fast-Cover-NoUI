...
if __name__ == '__main__':
    ...
    parser.add_argument('-p1', '--pitch-vocal', type=int, default=0, help='VOCAl PITCH CHANGE')
    parser.add_argument('-p2', '--pitch-other', type=int, default=0, help='OTHER PITCH CHANGE')
